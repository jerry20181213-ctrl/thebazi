...
export const metadata: Metadata = {
  title: "Chinese Zodiac Compatibility — Love & Friendship Matches",
  description: "Discover the compatibility between all 12 Chinese zodiac signs. Find your best love matches, friendship matches, and understand the ancient principles of Six Harmony, Triad Harmony, and Six Clash.",
  openGraph: {
    title: "Chinese Zodiac Compatibility Chart",
    description: "Complete guide to Chinese zodiac love and friendship compatibility.",
  },
};
