...
export const metadata = {
  title: "2026 Year of the Horse — Ba Zi Forecast & Predictions",
  description: "Discover what 2026 — the Year of the Fire Horse (丙午) — means for you. Ba Zi analysis of the year's energy, predictions for each zodiac sign, and tips for making the most of this powerful year.",
  openGraph: {
    title: "2026 Year of the Horse — Ba Zi Forecast",
    description: "Complete 2026 Year of the Fire Horse forecast. What this powerful year means for your zodiac sign.",
  },
};
