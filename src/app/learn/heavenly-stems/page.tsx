...
export const metadata = {
  title: "Heavenly Stems (Tian Gan) — Ba Zi Guide",
  description: "Complete guide to the 10 Heavenly Stems (天干) in Ba Zi astrology. Learn the meaning, element association, and personality of each stem in Chinese metaphysics.",
  openGraph: {
    title: "Heavenly Stems (Tian Gan) — Ba Zi Guide",
    description: "Learn the 10 Heavenly Stems — the celestial energies that shape your Ba Zi chart.",
  },
};
