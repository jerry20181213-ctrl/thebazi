...
export const metadata = {
  title: "Ba Zi Glossary — Key Terms & Concepts",
  description: "Comprehensive glossary of Ba Zi (Four Pillars of Destiny) terms. Understand Heavenly Stems, Earthly Branches, Five Elements, Day Master, and more.",
  openGraph: {
    title: "Ba Zi Glossary — Key Terms & Concepts",
    description: "Your complete reference to Ba Zi terminology.",
  },
};
