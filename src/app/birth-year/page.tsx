...
export const metadata = {
  title: "Chinese Zodiac Birth Year Guide — What Your Birth Year Reveals",
  description: "Look up any birth year from 1900 to 2031 to discover your Chinese zodiac sign, element, heavenly stem, earthly branch, and what they reveal about your personality and destiny.",
  openGraph: {
    title: "Chinese Zodiac Birth Year Guide — Find Your Sign & Element",
    description: "Complete birth year reference for Chinese zodiac. Search any year to discover your animal sign, element, and Ba Zi stem-branch combination.",
  },
};
