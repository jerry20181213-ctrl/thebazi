...
export const metadata = {
  title: "Earthly Branches (Di Zhi) — Ba Zi Guide",
  description: "Complete guide to the 12 Earthly Branches (地支) in Ba Zi astrology. Learn the meaning, animal association, element, and personality of each branch.",
  openGraph: {
    title: "Earthly Branches (Di Zhi) — Ba Zi Guide",
    description: "Discover the 12 Earthly Branches and their connection to the Chinese zodiac and Ba Zi.",
  },
};
