...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${sign.animal} Zodiac — Complete Personality Guide`,
      description: `${sign.animal} Chinese zodiac personality, career, love, and health profile. Element: ${ZODIAC_CONTENT[slug]?.element || "Various"}.`,
    },
  };
}
